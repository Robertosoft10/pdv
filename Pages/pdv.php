            ...
            <table class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th id="infor-item">Peso / Litro</th>
              ...
              <tbody>
                <tr class="odd gradeX">
                  <?php if(count($_SESSION['pdv']) == 0){?>
                    <hr>
                   <small id="alet-pdv"> PDV Livre inicie um novo pedido</small>
                 <?php }else{
                ...
                <td>
                 ...
                 <td>
                  ...
                  <td>
                    <a href="itens.php">
                    <button class="btn btn-primary"><i class="fa fa-plus"></i> Adicionar <br>Item</button></a>
                  </td>
                <?php }else{?>
                  <td>
                    <a href="itens.php">
